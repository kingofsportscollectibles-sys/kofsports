alter table public.nfl_prop_line_history
drop constraint if exists nfl_prop_line_history_market_check;

alter table public.nfl_prop_line_history
add constraint nfl_prop_line_history_market_check
check (
  market in (
    'player_pass_yds',
    'player_rush_yds',
...
history as (
  select
    ...
    case
      ...
      when p.market = 'player_receptions'
        and gs.receptions is not null
        then gs.receptions::numeric
      else null::numeric
    end as stat_value
