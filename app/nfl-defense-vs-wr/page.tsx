      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <section className="mt-12 max-w-4xl border-t border-white/10 pt-10">
          ...
          <p className="mt-4 leading-7 text-zinc-400">
            Defense vs wide receiver data helps isolate how much opportunity and production opposing receiver groups generate. Targets and receptions can help show volume, while receiving yards and touchdowns help show how efficiently that opportunity turns into production.
          </p>

          <p className="mt-4 leading-7 text-zinc-400">
            A ranking of #1 means the defense allowed the most
            fantasy production to WR players during the
