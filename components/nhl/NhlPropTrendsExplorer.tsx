...
type Props = {
  props: NhlPlayerPropTrend[];
  hasProAccess: boolean;
};

function marketLabel(market: NhlPropMarket) {
  switch (market) {
...
function getAverageEdge(prop: NhlPlayerPropTrend) {
  if (prop.avgL5 === null) {
    return null;
  }
          ...
          <div>
            ...
            <div className="mt-1 text-sm text-slate-400">
              ...
              {prop.upcomingOpponent
                ? ` • ${
                    prop.playerTeam === prop.awayTeam ? "@" : "vs"
                  } ${prop.upcomingOpponent}`
                : ""}
            </div>
          </div>
...
export default function NhlPropTrendsExplorer({
  props,
  hasProAccess,
}: Props) {
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-6">
          ...
          <div>
            ...
            >
              ...
              <option value="player_shots_on_goal">
                Shots on Goal
              </option>

              <option value="player_points">
                Points
              </option>

              <option value="player_assists">
                Assists
              </option>

              <option value="player_total_saves">
                Goalie Saves
              </option>
            </select>
          </div>
