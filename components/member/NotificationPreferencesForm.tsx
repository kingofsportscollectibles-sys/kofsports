...
export default function NotificationPreferencesForm({
    ...
    return (
      <section className="rounded-3xl border border-gray-200 bg-white p-6 text-black shadow-sm">
        ...
        <p className="mt-3 text-sm text-gray-500">
          Email alerts for newly published Premium Picks are
          available to active Premium members.
        </p>
  ...
  return (
    <section className="rounded-3xl border border-gray-200 bg-white p-6 text-black shadow-sm">
      <h2 className="font-bold text-black">
        Premium Pick Email Alerts
      </h2>

      <p className="mt-2 text-sm text-gray-500">
        Receive an email whenever a new Premium Pick is
        published.
      </p>
        ...
        <label className="flex cursor-pointer items-start gap-3 text-black">
          ...
          <span>
            ...
            <span className="mt-1 block text-xs leading-5 text-gray-500">
              Send newly published Premium Picks to your
